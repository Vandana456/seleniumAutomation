//In this selenium codesearch text in google search
//1.set up the propertyof webdriver to perform google search through chrome web browser 
//2.Initialize the WebDriver through ChromeDriver class
//3.Open the web pagewww.google.com
